  ...
  return (
    <View style={styles.container__loginUsuarios}>
      <Image
        ...
        source={{
          uri:
            "https://res.cloudinary.com/dcf9eqqgt/image/upload/v1755173809/Dise%C3%B1o_sin_t%C3%ADtulo_96_ofhqtu.png",
        }}
      />
      ...
      >
        ...
        <Picker
          ...
          style={{ width: 250, backgroundColor: "#34cee6", marginBottom: 20 }}
